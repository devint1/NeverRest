...
{
	public enum State{ Off, Done, Commence, Pause, Selection, Move, Unpause, PlateProduction, DiseaseBasicSpawn, WBCProduction, Finish, EnemySpawn, WaitForLevelTwo, WaitForLevelThree, WaitForLevelFour };
}
